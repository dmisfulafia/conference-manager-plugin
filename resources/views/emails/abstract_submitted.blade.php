...
<head>
    ...
    <title>Abstract Submission Received</title>
    <style>
        body {
    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="header">
                ...
                <p>Conference Abstract Submission</p>
            </div>
            ...
            <div class="content">
                ...
                <div class="intro-text">
                    Thank you for submitting your abstract proposal for the upcoming conference. We have successfully received your submission and it has been queued for review by the academic panel.
                </div>
                ...
                <div class="details-card">
                    ...
                    <div class="detail-row">
                        <div class="detail-label">Abstract Title</div>
                ...
                <p class="intro-text">
                    <strong>What's next?</strong> Our moderation panel will thoroughly review your abstract. Once a decision is made, you will receive an automatic email notification indicating whether your abstract has been approved. If approved, you will be authorized to submit your full-length paper.
                </p>
                
                <a href="{{ route('dashboard') }}" class="cta-button">Monitor Submission Status</a>
            </div>
