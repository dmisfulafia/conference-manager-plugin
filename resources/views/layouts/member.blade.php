...
<body>
    ...
    <!-- Credo Dynamic Inline SDK -->
    @php
        $credoApiUrl = env('CREDO_API_URL', 'https://api.credodemo.com');
        $inlineScriptUrl = (strpos($credoApiUrl, 'credodemo.com') !== false) 
            ? 'https://pay.credodemo.com/inline.js' 
            : 'https://pay.credocentral.com/inline.js';
    @endphp
    <script src="{{ $inlineScriptUrl }}"></script>
